<div class="row mb-3">
    ...
    <div class="col-md-6">
        <select name="elderlies_number" id="elderlies_number" class="form-control" @error('elderlies_number') is-invalid @enderror>
            ...
            @foreach (App\Models\User::$elderlies_range as $range_key => $range_value)
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="establishment_date" type="date" class="form-control @error('establishment_date') is-invalid @enderror" name="establishment_date" value="{{ old('establishment_date') }}" required>
